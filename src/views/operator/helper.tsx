...
import type { CreateManagerSchemaTypeWithId } from "../manger/helper";
...
export type CreateOperatorSchemaType = z.infer<typeof createOperatorSchema>;
export type CreateOperaterSchemaTypeWithId = CreateOperatorSchemaType & {
  _id: string;
};
export const columns: ColumnDef<CreateOperaterSchemaTypeWithId>[] = [
  {
