...
const NewsletterSignUp = () => {
  ...
  return (
    <div>
      <div className='flex items-center justify-between gap-2 rounded-3xl bg-primary p-16 text-white'>
        <div>
        ...
        <div>
          ...
          <div className='flex items-center rounded-full bg-white p-3'>
            ...
            <Button
              type='button'
              className='h-10 rounded-full bg-primary text-white hover:bg-teal-600 focus:bg-teal-800 focus:ring focus:ring-teal-300'
