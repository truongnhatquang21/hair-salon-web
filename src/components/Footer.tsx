  ...
  return (
    <footer className="border-t bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-16 lg:px-8 lg:pt-16">
        <div className="items-start xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="flex flex-col items-center space-y-4">
            <Link
              href="/"
              className="flex items-center gap-0   border-foreground font-sans text-xl font-extrabold  "
            >
              ...
              />
              <span className="relative -left-4 inline-block  uppercase ">
                nton
              </span>
            </Link>
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link
                href="?#"
                className="hover:text-blue-4 00      text-gray-400"
              >
          ...
          <div className="mt-16 grid  grid-cols-2 justify-items-center gap-8 pb-10 xl:col-span-2 xl:mt-0">
            <div className="justify-items-center md:grid md:grid-cols-2 md:gap-8">
              <div>
        ...
        <div className="justify-centermt-16 flex border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="mx-auto text-xs leading-5 text-gray-500">
            &copy; 2024 Bookminton , Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
